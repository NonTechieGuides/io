    ...
    <footer className="bg-base2 dark:bg-base03">
      <div className="max-w-6xl mx-auto px-4 sm:px06">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md py-12 border-t border-violet">
            ...
            <div className="mb-2">
              {/* Logo */}
              <Link href="/" passHref className="inline-block" aria-label="Cruip">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
            ...
            <li>
              <Link href="#" passHref className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <Link href="#" passHref className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <Link href="#" passHref className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4 uppercase">&copy; 2020 Non-Techie Guides. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
